...
!function(){d.f.pageTurn=function(e,n){d.t.get("af/ls",{p:"number"==typeof e&&e?e:1},function(e){e.records.map(function(e,n){var c=d.e.records[n],t=e.info,a={};t.map(function(e){e.map(function(e){"m"==e.name&&(a[e.text]=!0)})}),c.find(".sName").html(e.name),c.find(".sLink").attr("href","http://"+e.main[0]),c.find(".sMain").html(Object.keys(a).join("; "))}),n&&n(e.now,e.max)})}}(),function(){d.e.Search.on("click",d.f.pageTurn),d.t.pager("record",d.e.RecordPrev,d.e.RecordNext,d.e.RecordPage,d.e.RecordPageMax,d.f.pageTurn)}(),function(){d.e.Search.click()}();