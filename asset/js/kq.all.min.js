...
!function(){d.f.pageTurn=function(e){d.t.get("af/ls",{p:"number"==typeof e&&e?e:1},function(e){d.e.records.map(function(a,d){var i=e.records[d];if(i){var n=i.info,t={};n.map(function(e){e.map(function(e){"m"==e.name&&(t[e.text]=!0)})}),a.find(".sName").html(i.name),a.find(".sLink").attr("href","http://"+i.main[0]),a.find(".sMain").html(Object.keys(t).join("; "))}a.children()[i?"removeClass":"addClass"]("hide"),a[i?"removeClass":"addClass"]("hidden")}),d.t.pagerDeal(e.now,e.max,d.v.pager.record)})}}(),function(){d.t.pager("record",d.e.RecordPrev,d.e.RecordNext,d.e.RecordPage,d.e.RecordPageMax,d.f.pageTurn),d.t.taber("RightNavi",d.e.RightNaviHead,d.e.RightNaviItem,["Basic","Config","About"],"active"),d.e.Search.on("click",d.f.pageTurn)}(),function(){d.e.Search.click(),d.e.RightNaviHead.first().click()}();