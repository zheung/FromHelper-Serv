...
!function(){d.e.Search.click(function(){d.t.get("af/ls",{p:1},function(n){n.map(function(n,c){var i=d.e.records[c],t=n.info,e={};t.map(function(n){n.map(function(n){"m"==n.name&&(e[n.text]=!0)})}),i.find(".sName").html(n.name),i.find(".sMain").html(Object.keys(e).join("; "))})})})}(),function(){d.e.Search.click()}();